                ...
                child: FilledButton(
                  onPressed: () {
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (_) =>
                            const PaymentPage(paidCurrency: Currency.bgn),
                      ),
                    );
                  },
                ...
                child: FilledButton(
                  onPressed: () {
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (_) =>
                            const PaymentPage(paidCurrency: Currency.eur),
                      ),
                    );
                  },
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _ResultRow(
                        label: 'В лева',
                        value: Money.formatBgnFromStotinki(
                            _output!.changeBgnStotinki),
                        bold: true,
                      ),
                      const SizedBox(height: 8),
                      _ResultRow(
                        label: 'В евро',
                        value:
                            Money.formatEurFromCents(_output!.changeEurCents),
                        bold: true,
                      ),
                      const SizedBox(height: 10),
                      Text(
